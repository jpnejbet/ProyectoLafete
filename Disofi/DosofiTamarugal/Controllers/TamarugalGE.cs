    ...
    public class TamarugalGEController : Controller
    {
        ...
        public ActionResult CreacionContrato()
        {
            try
            {
                ...
                ds = maestrosLocales.ListadoClientes();

                ObjetoCliente bodega = new ObjetoCliente();
                var _ListadoBodega = new List<ObjetoCliente>();
                ...
                foreach (DataTable table in ds.Tables)
                {
                    foreach (DataRow dr in table.Rows)
                    {
                        ...
                        {
                            Text = Convert.ToString(dr["NomAux"]),
                            Value = Convert.ToString(dr["NomAux"])
                        });
                    }
                }
                ViewBag.CmbCliente = list;
        ...
        [HttpGet()]
        public ActionResult DetalleServicioTamarugalId2(string _idguia, string _numeroPedido)
        {
            try
            {
                Session["_idguiaExpedicion"] = _idguia;
                ...
                List<ObjetoSeguimientoDetalleContratoGrid> listarDetalleServicio = _control.DetalleServicioTamarugalId2(_idguia, _numeroPedido);
        ...
        public ActionResult Rendicion(int _IdConductor)
        {
            try
            {
                var datosUsuario = new ObjetoLogin();
                ...
                IEnumerable<ObjetoRecepcionGuia> model = _control.ListadoRendicion(_IdConductor);
        ...
        public ActionResult Rendicion2()
        {
            try
            {
                var datosUsuario = new ObjetoLogin();
                ...
                int idconductor = int.Parse(Session["IdConductorRendidor"].ToString());

                IEnumerable<ObjetoRecepcionGuia> model = _control.ListadoRendicion(idconductor);
        ...
        public ActionResult Recepcion(int _IdConductor)
        {
            try
            {
                var datosUsuario = new ObjetoLogin();
                ...
                Session["IdConductorRendidor"] = _IdConductor;

                IEnumerable<ObjetoRecepcionGuia> model = _control.ListadoGuiaRecepcion(_IdConductor);
        ...
        public ActionResult GrabarRecepcionGuia(
                        string _Id,
                        string _Patente,
                        ...
                        string _IdDespacho)
        {
            ...
            return (ActionResult)this.Json((object)validador);
        }




        public ActionResult GrabarDespacho(
                                string _Id,
                                ...
                                string _Estado)
        {
...

            {
                ...
                idDespacho = _control.SetGrabaTamarugalDetalleGuiaExpedicion(guia);


                Session["idGuiImprimir"] = _IdGuiaExpedicion.ToString();
                Session["IdNumepedidoImprimir"] = idDespacho.ToString();
            ...
            catch (Exception ex)
            {
                ...
                Session["idGuiImprimir"] = "";
                Session["IdNumepedidoImprimir"] = "";
                validador = -1;
                throw;
            }

            return (ActionResult)this.Json((object)idDespacho);
        }
        ...
        public ActionResult Pdf2()
        {
            ...
            string idguia = Session["idGuiImprimir"].ToString();
            string _numeroPedido = Session["IdNumepedidoImprimir"].ToString();
