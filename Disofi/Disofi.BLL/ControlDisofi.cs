...
namespace Disofi.BLL
{
    public class ControlDisofi
    {
        ...
        {
            return _dtFac.ListadoSeguimientoModificacion();
        }
      ...
      public List<ObjetoProductoAgrupado> ListadoPedidoPicking(string grupo)
        {
            return _dtFac.ListadoPedidoPicking(grupo);
        }
        ...
        {
            return _dtFac.SetModificaPedido(id, stock);
        }
